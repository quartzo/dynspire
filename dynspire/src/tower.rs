...
/// Static IDL metadata generated by `#[modulo_interface]`.
///
...
/// Trait implemented by the `{Prefix}Op` enum generated by `#[modulo_interface]`.
///
...
impl DynSpireClient {
    ...
    /// `#[modulo_interface]` in the IDL crate. The spier is found by name
